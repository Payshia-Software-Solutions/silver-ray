...
export const weddingVenues: WeddingVenue[] = [
  {
    ...
    features: [
      { icon: Users, text: '300 guests' },
      { icon: Disc, text: 'Dance Floor' },
      { icon: Mic, text: 'AV Equipment' },
      { icon: Sun, text: 'Ambient Lighting' },
    ],
  },
  {
    id: 'garden-terrace',
    ...
    features: [
      { icon: Users, text: '100 guests' },
      { icon: Trees, text: 'Outdoor Setting' },
      { icon: Sun, text: 'Fairy Lights' },
      { icon: Speaker, text: 'PA System' },
    ],
  },
  {
    id: 'emerald-lounge',
    ...
    features: [
      { icon: Users, text: '60 guests' },
      { icon: Wine, text: 'Built-in Bar' },
